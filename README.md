...
# ___Crpt API - приложение для работы с API Честный Знак___
...
+ Библиотека для сериализации JSON
```
<dependency>
...
## Описание
    ...
    При превышении лимита запрос должен блокироваться, чтобы не превысить максимальное количество запросов к API и продолжить выполнение, 
    когда ограничение не превышено.
